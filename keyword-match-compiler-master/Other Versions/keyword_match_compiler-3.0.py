...
if more_inputs == 'Y':
	...
	while keyword_5a == '':
		keyword_5a = input('\nYou must enter at least one key word or phrase: ')
	keyword_5b = input('Enter a second key word or phrase: ')
	keyword_5c = input('Enter a third key word or phrase: ')
	
	print('\nKeyword Compilation 6')
	keyword_6a = input('\nEnter the first key word or phrase: ')
	while keyword_6a == '':
		keyword_6a = input('\nYou must enter at least one key word or phrase: ')	
	keyword_6b = input('Enter a second key word or phrase: ')
	keyword_6c = input('Enter a third key word or phrase: ')
	
	print('\nKeyword Compilation 7')
	keyword_7a = input('\nEnter the first key word or phrase: ')
	while keyword_7a == '':
		keyword_7a = input('\nYou must enter at least one key word or phrase: ')
	keyword_7b = input('Enter a second key word or phrase: ')
	keyword_7c = input('Enter a third key word or phrase: ')
	
	print('\nKeyword Compilation 8')
	keyword_8a = input('\nEnter the first key word or phrase: ')
	while keyword_8a == '':
		keyword_8a = input('\nYou must enter at least one key word or phrase: ')
	keyword_8b = input('Enter a second key word or phrase: ')
	keyword_8c = input('Enter a third key word or phrase: ')	
...
if more_inputs == 'Y':
	...
	print('\nKeyword Compilation 5')
	print('\nFirst keyword: ', keyword_5a)
	print('Second keyword: ', keyword_5b)
	print('Third keyword: ', keyword_5c)
	
	print('\nKeyword Compilation 6')
	print('\nFirst keyword: ', keyword_6a)
	print('Second keyword: ', keyword_6b)
	print('Third keyword: ', keyword_6c)
	
	print('\nKeyword Compilation 7')
	print('\nFirst keyword: ', keyword_7a)
	print('Second keyword: ', keyword_7b)
	print('Third keyword: ', keyword_7c)
	
	print('\nKeyword Compilation 8')
	print('\nFirst keyword: ', keyword_8a)
	print('Second keyword: ', keyword_8b)
	print('Third keyword: ', keyword_8c)	
