...
txt_file = Path(directory, str(project) + '_parse.txt')  # creates the absolute path of the TXT file.
...
sys.stdout = open(txt_file, "w")  # makes the print function output to the TXT file.
...
print('\nContent exported to file: ', str(project) + '_parse.txt')
file_size = os.path.getsize(txt_file)
print('File size : ', str('{:,}'.format(file_size)), ' bytes')
print('File location: ', str(Path(txt_file.anchor, txt_file.parent)))
